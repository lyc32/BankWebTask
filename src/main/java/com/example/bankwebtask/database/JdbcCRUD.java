package com.example.bankwebtask.database;
...
public class JdbcCRUD implements JdbcCRUDInterface
{
    @Override
    ...
    public ResultSet searchData(Connection connection, String columList, String tableName, String whereCondition)
    {
        ...
        {
            Statement statement = connection.createStatement();
            System.out.println("SELECT " + columList + " FROM " + tableName + " WHERE " + whereCondition);
